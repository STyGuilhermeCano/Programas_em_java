...
/*2 Considere, como subclasse da classe Pessoa (desenvolvida no exercício anterior)
	 a classe Fornecedor. Considere que cada instância da classe Fornecedor tem, para além dos atributos que 
	caracterizam a classe Pessoa, os atributos valorCredito (correspondente ao crédito máximo atribuído ao
	 fornecedor) e valorDivida (montante da dívida para com o fornecedor). Implemente na classe Fornecedor,
	 ...
	 na classe Fornecedor e os herdados da classe Pessoa. */
		...
		// importado de pessoa
		 ...
		 double valorCredito;  
		 double valorDivida ; 
		 double obterSaldo; //devolve a diferença entre os valores dos atributos valorCredito e valorDivida.
		
		 
		
		public void obterSaldo() {
			 obterSaldo = (valorCredito-valorDivida);
			 System.out.println("valor do saldo é igual a = R$ "+obterSaldo);
		}
		...
		// um método obterSaldo() que devolve a diferença
		// entre os valores dos atributos valorCredito e valorDivida.
